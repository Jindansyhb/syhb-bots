...
/////////////////
const BotName = 'SYHB BOT☄'; 
const instagram = 'https://instagram.com/jindansyhb'; 
const telegram = 'https://t.me/Jindansyhb'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@jindansyhb')
